...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Helmet>
        <title>브레인시티 비스타동원 - 모집공고 안내</title>
        <meta
          name="description"
          content="평택 동구 신천동 브레인시티 비스타동원 모집공고를 한눈에 확인하세요. 공급세대수·공급면적·분양가, 청약일정·자격, 당첨자 발표·계약 및 유의사항을 안내합니다."
        />
        <link
          rel="canonical"
      ...
      <p className={styles.screenReaderOnly}>
        브레인시티비스타동원모집 공고는 분양 전 단계에서 중요한
